...
var DEFAULT_URL = document.getElementById("xyzsmark").value;//'http://mozilla.github.io/pdf.js/web/compressed.tracemonkey-pldi-09.pdf';
...
function configure(PDFJS) {
  ...
  PDFJS.workerSrc = '/static/plugins/pdf.js/web/pdf.worker.js';
      ...
      onActiveChanged: function(isActive) {
        ...
        if (isActive) {
          toggleHandTool.title =
            mozL10n.get('hand_tool_disable.title', null, '禁用手型工具');
          toggleHandTool.firstElementChild.textContent =
            mozL10n.get('hand_tool_disable_label', null, '禁用手型工具');
        } else {
          toggleHandTool.title =
            mozL10n.get('hand_tool_enable.title', null, '启动手型工具');
          toggleHandTool.firstElementChild.textContent =
            mozL10n.get('hand_tool_enable_label', null, '启动手型工具');
        }
      }
    });
    if (toggleHandTool) {
