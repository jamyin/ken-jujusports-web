		...
		var app = {
			...
			canSlideUp : function() {
			    if (currentSlideIndex === 0) {
			        ...
			        $("#nav_d" + currentSlideIndex).css({ "top": "-40px", "opacity": "1" }).addClass("_transition");
			        return true;
			    } 
			},
			...
			canSlideDown: function () {
			    ...
			    if ($(options.selector, body).eq((currentSlideIndex + 1)).length === 0) {
					var left = 120*currentSlideIndex + 30
					$("#nav_d" + currentSlideIndex + ' ._border').css({ left:left + "px" })	
			         $("#nav_d" + currentSlideIndex).css({ "top": "-40px", "opacity": "1" }).addClass("_transition");
			        return false;
			    } else {
			        $(".nav_d").each(function () {
					...
					if (currentSlideIndex == 1) {
						$('.side6_wxalert, .side6_mask_t').addClass('show')
			        }
					...
					if (currentSlideIndex == 3) {
						$(".side2_cont").css({ "margin-top": "0%", "opacity": "1" }).addClass("_transition");
						$('.cont1, .cont2, .cont3, .cont4, .cont5, .cont6').addClass('show')
			        }

			        if (currentSlideIndex == 4) {
						$('.side3_left, .side3_right').addClass('show')
			        }
					
			        if (currentSlideIndex == 5) { 
						$('.side4_cont').addClass('show')
						setTimeout(function () {$('.side4_cont ul li').eq(0).addClass('show')}, 1000);
						setTimeout(function () {$('.side4_cont ul li').eq(1).addClass('show')}, 1200);
						setTimeout(function () {$('.side4_cont ul li').eq(2).addClass('show')}, 1400);
						setTimeout(function () {$('.side4_cont ul li').eq(3).addClass('show')}, 1600);
						setTimeout(function () {$('.side4_cont ul li').eq(4).addClass('show')}, 1800);
						setTimeout(function () {$('.side4_cont ul li').eq(5).addClass('show')}, 2000);
			        }
